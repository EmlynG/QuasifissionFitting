...
//		   should be defined (min max optional, MINUIT is faster and gives
//		   better error estimates without these but may find non-physical values).
//		   Variables may also be fixed at a specific value if the user does not
//		   wish to fit them.
//
//-----------------------------------------------------------------------------------------
//-----------------------------------------------------------------------------------------
...
double madfitfcn(double avg, double sig, double shellfrac){
	...
	Double_t KSerror = plot5->KolmogorovTest(plot1,"M UU");
...
//-----------------------------------------------------------------------------------------
//	Open experiment files globally, scale.
//-----------------------------------------------------------------------------------------
